...
<html>
    ...
    <body>
        <%
            ...
            lista = carroDAO.consultar_lista();  
        %>
        <main>
            <div class="flex justify-between mb-4">
                <h2 class="text-3xl text-gray-900 font-semibold">Carros</h2>
                <a
                  href="inserir/index.html"
                ...
                <table class="w-full text-sm text-left text-gray-700">
                    <thead class="text-gray-400">
                        <tr>
                            ...
                            <th class="px-4 py-3 font-normal">Modelo</th>
                            <th class="px-4 py-3 font-normal">Marca</th>
                            <th class="px-4 py-3 font-normal">Ano</th>
                            <th class="px-4 py-3 font-normal">Placa</th>
                            <th class="px-4 py-3 font-normal">Status</th>
                            <th class="px-4 py-3 font-normal">Diária</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr class="border-b border-gray-100">
                            ...
                            <td class="px-4 py-3 font-semibold text-gray-900"><%= lista.get(i).getModelo() %></td>
                            <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getMarca() %></td>
                            <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getAno() %></td>
                            <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getPlaca() %></td>
                            <td class="px-4 py-3">
                                <% 
                                    String statusClass = "";
                                    if (lista.get(i).getStatus() == model.StatusCarro.DISPONIVEL) {
                                ...
                                %>
                                <span
                                  class="inline-block <%= statusClass %> text-xs font-medium p-3 rounded-lg"
                                >
                                    <%= lista.get(i).getStatus() %>
                                </span>
                            </td>
                            <td class="px-4 py-3 text-gray-400">R$ <%= lista.get(i).getPreco() %></td>
                            <td class="relative px-4 py-3">
                                ...
                                >
                                  <a
                                    href="./alterar/index.jsp?id=<%=lista.get(i).getId()%>"
                                  ...
                                  <a
                                    href="./excluir.jsp?id=<%=lista.get(i).getId()%>"
                                    onClick= "return confirm('Tem certeza que deseja excluir?') "
                                    class="group flex items-center gap-2 p-2 text-gray-400 hover:bg-orange-100 hover:text-orange-400 rounded-sm transition-all duration-300 ease-in-out"
                                  >
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 25 25"  class="size-4 fill-current group-hover:fill-orange-400">
                                      <mask id="mask0_17_7" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="25" height="25">
                                      <rect x="0.738037" y="0.505615" width="24" height="24"/>
                                      </mask>
                                      <g mask="url(#mask0_17_7)">
                                      <path d="M7.73804 21.5056C7.18804 21.5056 6.7172 21.3098 6.32554 20.9181C5.93387 20.5264 5.73804 20.0556 5.73804 19.5056V6.50562H4.73804V4.50562H9.73804V3.50562H15.738V4.50562H20.738V6.50562H19.738V19.5056C19.738 20.0556 19.5422 20.5264 19.1505 20.9181C18.7589 21.3098 18.288 21.5056 17.738 21.5056H7.73804ZM17.738 6.50562H7.73804V19.5056H17.738V6.50562ZM9.73804 17.5056H11.738V8.50562H9.73804V17.5056ZM13.738 17.5056H15.738V8.50562H13.738V17.5056Z"/>
                                      </g>
                                    </svg>
                                    Excluir
                                  </a>
