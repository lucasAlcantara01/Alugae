...
<html>
    ...
    <body>
        <%
            ...
            lista = clienteDAO.consultar_lista();
            
        %>
        <main>
            <div class="flex justify-between mb-4">
                <h2 class="text-3xl text-gray-900 font-semibold">Clientes</h2>
                <a
                ...
                <table class="w-full text-sm text-left text-gray-700">
                  <thead class="text-gray-400">
                    <tr>
                      ...
                      <th class="px-4 py-3 font-normal">Telefone</th>
                      <th class="px-4 py-3 font-normal">CPF</th>
                  ...
                  <tbody class="bg-white">
                    ...
                    <tr class="border-b border-gray-100">
                      ...
                      <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getTelefone() %></td>
                      <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getCpf() %></td>
