...
<html>
    ...
    <body>
        <%
            ...
            lista = locacaoDAO.consultar_lista();
            
        %>
        <main>
            <div class="flex justify-between mb-4">
                <h2 class="text-3xl text-gray-900 font-semibold">Locação</h2>
                <a
                ...
                <table class="w-full text-sm text-left text-gray-700">
                  <thead class="text-gray-400">
                    <tr>
                      ...
                      <th class="px-4 py-3 font-normal">Carro</th>
                      <th class="px-4 py-3 font-normal">Data Inicio</th>
                      <th class="px-4 py-3 font-normal">Data Fim</th>
                      <th class="px-4 py-3 font-normal">Valor Total</th>
            ...
            <tr class="border-b border-gray-100">
                      ...
                      <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getDataInicio() %></td>
                      <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getDataFim() %></td>
                      <td class="px-4 py-3 text-gray-400"><%= lista.get(i).getValorTotal() %></td>
                      <td class="px-4 py-3">
                            <% 
                                String statusClass = "";
                                if (lista.get(i).getStatus() == model.StatusLocacao.ATIVA) {
                                    statusClass = "bg-green-200 text-green-800";
                                } else if (lista.get(i).getStatus() == model.StatusLocacao.FINALIZADA){
